...
WHERE users_server.userid = '" . $_SESSION["id"] . "' AND server.serverip = '" . $_SESSION["ip"] . "'";
                ...
                ?>
                  ...
                  <div class="card">
                    <div class="card-header">
                      <h3>Anticheat Logs</h3><span></span>
                      <caption>The last 1000 Anticheat Logs of your Server</caption>
                    </div>
      ...
      <div class="col-sm-12 col-lg-12 col-xl-12">
        ...
        <div class="table-responsive">
                          <table class="table">
                            <caption>Anticheat Logs for your Server</caption>
                            <thead>
                              <tr>
                            <th>Reason</th>
                             <th>Date</th>
