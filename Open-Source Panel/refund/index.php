...
<body>
  <div class="container">
    ...
    <p>The deadline for cancelling an Order is 14 days from the date on which You received the Goods or on which a third
    ...
    <ul>
      <li>By our Email: <a href="mailto:contact@imoshield.net">contact@imoshield.net</a></li>
    </ul>
    <p>We will reimburse You no later than 14 days from the day on which We receive the returned Goods. We will use the
      store credits that you can use to repurchase goods at <a
        href="https://shop.imoshield.net">https://shop.imoshield.net</a>.</p>
