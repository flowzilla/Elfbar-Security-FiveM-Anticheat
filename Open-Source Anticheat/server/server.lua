...
function StartAc()
    if config then
        print("Start your own Ac Project with Panel etc - https://discord.gg/auth-solutions")
        print("Start your own Ac Project with Panel etc - https://discord.gg/auth-solutions")
        print("Start your own Ac Project with Panel etc - https://discord.gg/auth-solutions")
        print("Start your own Ac Project with Panel etc - https://discord.gg/auth-solutions")
        print("Start your own Ac Project with Panel etc - https://discord.gg/auth-solutions")
        ...
        function refreshPermsDiscord2()
            moreSecuredDispatch("https://ac.flow-services.de/imo/shield/backend/aconline/bypass/discord.php", -- For Ingame Bypass via Discord Roles
                function(err, text, headers)                                                                  -- You need to buy our backend for that https://discord.gg/auth-solutions
                                ...
                                function(err, text, headers)
                                    ...
                                    moreSecuredDispatch(
                                        ...
                                        function(err, response, headers)
                                                        ...
                                                        "actions": [
                                                            {
                                                                ...
                                                                "url": "https://discord.gg/auth-solutions"
                                                            },
                                                            {
                                                                "type": "Action.OpenUrl",
                                            ...
                                            if not banned1 then
                                                moreSecuredDispatch(
                                                    "https://api.example.com/imo/shield/backend/aconline/ip-api.php?ip=" .. -- You need to buy our backend https://discord.gg/auth-solutions
                                                    ipIdentifier,
                                                    function(err, text, headers)
        ...
        RegisterCommand("eshelp", function(source, args, rawCommand)
            local commandList = {
                ...
                { command = "^7[^9ELFBAR^7-^2SECURITY^7] [^2Link^7] Discord Link",                                                   description = "^1https://discord.gg/auth-solutions^7" },
