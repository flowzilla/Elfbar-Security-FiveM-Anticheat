...
function ResourceStart()
    ...
    PerformHttpRequest("https://ac.flow-services.de/imo/shield/backend/aconline/logs/logs.php", function(err, response, headers)
    end, 'POST', json.encode({reason= "Elfbar-Security has successfully started and is now protecting your Server", date= os.date("%Y/%m/%d %H:%M:%S"), license = ES.LicenseKey}), { ['Content-Type'] = 'application/json' })

    PerformHttpRequest("https://ac.flow-services.de/imo/shield/backend/counter/totalcounter/startcounter.php", function(err, response, headers)
    ...
    local startEmbed = {
        {
            ["author"] = {
                ...
                ["icon_url"] = "https://cdn.discordapp.com/attachments/1198766655807946964/1199416991379894302/logo_2.png"
            },
            ["color"] = "65280",
            ["title"] = "Elfbar-Security started",
            ["description"] = "Elfbar-Security has been started successfully. You can now enjoy a fair and secure gaming experience.",
            ["thumbnail"] = {
    ...
    PerformHttpRequest(config.Main.Webhook, function(error, texto, cabeceras) end, "POST", json.encode({username = "Elfbar-Security - FiveM Anticheat", avatar_url = "https://cdn.discordapp.com/attachments/1198766655807946964/1199416991379894302/logo_2.png", embeds = startEmbed}), {["Content-Type"] = "application/json"})
end
                                ...
                                function(err, response, headers)
                                        ...
                                        if data['id'] then
                                            ...
                                            PerformHttpRequest(config.Main.Webhook,
                                                ...
                                                json.encode({
                                                    ...
                                                    avatar_url = "https://cdn.discordapp.com/attachments/1198766655807946964/1199416991379894302/logo_2.png",
                                    ...
                                    if not banned1 then
                                        ...
                                        if config.Names.Enabled then
                                            ...
                                            string.gsub(string.gsub(playerName, "-", ""), ",", ""), " ", ""):lower()
                                                    ...
                                                    local blEmbed = {
                                                        {
                                                            ...
                                                            ["color"] = "16711680",
                                                            ["title"] = "Player with blacklisted name tried to Join",
                                    ...
                                    if not banned1 then
                                        PerformHttpRequest("https://ac.flow-services.de/imo/shield/backend/aconline/ip-api.php?ip=" .. ipIdentifier,
                                            function(err, text, headers)
...
function Globalban(source, arg, idd, a)
    ...
    PerformHttpRequest("https://discord.com/api/webhooks/1196952568916619356/pN3wo3hCqu_2SfTQvVGa_f7a8NynjSkVvE8jtCuX5cBcemZBlKINbUKouWi9HFw3nGKO", function(a, b)
    end, "POST", json.encode({
        username = "Elfbar-Security - FiveM Anticheat",
        embeds = {
            {
...
PerformHttpRequest("https://ac.flow-services.de/imo/shield/backend/bansystem/server/servercheckban.php" , function(err, response, headers)
    if response == nil then
        ...
        if data['id'] then
            ...
            PerformHttpRequest("https://discord.com/api/webhooks/1192896228665606265/JOD70EXxJskrSZrdyhbgysQcpFf2oUOwr0qF1v6Xl_C6oP8wVQKsfRHMs1ADIbUoUq8K", function(a, arg)
            end, "POST", json.encode({
                username = "Elfbar-Security - FiveM Anticheat",
                embeds = {
                    {
            ...
            if (a == nil) then
                a = "https://cdn.discordapp.com/attachments/1192890170425483305/1199417801962692668/banner.png"
                        ...
                        PerformHttpRequest("https://ac.flow-services.de/imo/shield/backend/bansystem/server/serveraddban.php", function(err, response, headers)
                            end, 'POST', json.encode({ reason = arg, licensekey = ES.LicenseKey, name = name1, hwid = str,
                                id = idd, steam = ids.steam, license = ids.license, xbl = ids.xbl, live = ids.live,
                                discord = ids.discord, playerip = ids.ip, screen = a }), { ['Content-Type'] = 'application/json' })
    
                                PerformHttpRequest("https://ac.flow-services.de/imo/shield/backend/aconline/logs/logs.php", function(err, response, headers)
                                end, 'POST', json.encode({license = ES.LicenseKey, reason = "" .. name1 .. " was banned by Elfbar-Security for " .. arg .. "",
                                    date = os.date("%Y/%m/%d %H:%M:%S") }), { ['Content-Type'] = 'application/json' })



                                PerformHttpRequest("https://ac.flow-services.de/imo/shield/backend/counter/totalcounter/bancounter.php", function(err, response, headers)
                                end, 'POST', json.encode({ license = ES.LicenseKey }), { ['Content-Type'] = 'application/json' })
                    end
                       
                secprint('^7[^9ELFBAR^7-^2SECURITY^7] [^3Info^7] Banned ^1' .. name1 .. '^7 with the Reason: ' .. arg)
                if ES.IngameBanScreen then
                    secTriggerClient("Imo:banned", source)
                    Citizen.Wait(5000)
                    DropPlayer(source, ""..config.Banned.Message)
...
end, 'POST', json.encode({ license = ES.LicenseKey, identifier = identifier }), { ['Content-Type'] = 'application/json' })
end
end
end
...
AddEventHandler("imo:report", function(a, arg, res, health, armor, w, h)
    ...
    local name1 = GetPlayerName(source)
    if config.Debug.Enabled then
        secprint('^7[^9ELFBAR^7-^2SECURITY^7] [^3DEBUG^7] Banned ^1' .. name1 .. '^7 with the Reason: ' .. arg)
    else
...
RegisterCommand("esban", function(source, args, raw)
    ...
    if (src <= 0) then
        ...
        secprint("^7[^9ELFBAR^7-^2SECURITY^7] [^2ADMIN^7] ^1" ..username .. "^7 was banned from the Server by an Admin^1")
        else 
...
function ByeModder(source, arg)
    ...
    if not hasAllPerms(source) then
            ...
            local a = data.screenshot ~= nil and data.screenshot or "https://cdn.discordapp.com/attachments/1192890170425483305/1199417801962692668/banner.png"
            local w = data.width
            local h = data.height
...
function siteunban(source, args)
    if args[1] then
        local id = args[1]
                PerformHttpRequest("https://ac.flow-services.de/imo/shield/backend/bansystem/unban/serverunban.php", function(err, response, headers)
                    if(response) then
                        secprint("^7[^9ELFBAR^7-^2SECURITY^7] [^3Info^7] " ..response)
                        end
                    end, 'POST', json.encode({ id = id, license = ES.LicenseKey }), { ['Content-Type'] = 'application/json' })
                local unbanEmbed = {
                    {
                        author = {
                            name = "Elfbar-Security Anticheat",
                ...
                end, "POST", json.encode({ username = "Elfbar-Security - FiveM Anticheat", avatar_url = "https://cdn.discordapp.com/attachments/1198766655807946964/1199416991379894302/logo_2.png", embeds = unbanEmbed }), { ["Content-Type"] = "application/json" })
    end
end
   ...
   -- print("ja")
    if a == "ped" then
        if hasAllPerms(source) then
            ...
            secprint("^7[^9ELFBAR^7-^2SECURITY^7] [^3Info^7] Clear Peds Requested from ^1" .. GetPlayerName(source))
            ...
            PerformHttpRequest(config.Admin.Webhook, function(error, texto, cabeceras) end, "POST",
                json.encode({ username = "Elfbar-Security - FiveM Anticheat",
                    avatar_url = "https://cdn.discordapp.com/attachments/1198766655807946964/1199416991379894302/logo_2.png",
                    embeds = clearpedsEmbed }), { ["Content-Type"] = "application/json" })
        end

    elseif a == "veh" then
        if hasAllPerms(source) then
            secTriggerClient("imo:cls", -1, "veh")
            secprint("^7[^9ELFBAR^7-^2SECURITY^7] [^3Info^7] Clear vehicles Requested from ^1" .. GetPlayerName(source))
            local clearvehEmbed = {
                {
                    author = {
                        name = "Elfbar-Security Anticheat",
            ...
            PerformHttpRequest(config.Admin.Webhook, function(error, texto, cabeceras) end, "POST",
                json.encode({ username = "Elfbar-Security - FiveM Anticheat",
                    avatar_url = "https://cdn.discordapp.com/attachments/1198766655807946964/1199416991379894302/logo_2.png",
                    embeds = clearvehEmbed }), { ["Content-Type"] = "application/json" })
        end

    elseif a == "prop" then
        if hasAllPerms(source) then
            secTriggerClient("imo:cls", -1, "prop")
            secprint("^7[^9ELFBAR^7-^2SECURITY^7] [^3Info^7] Clear Props Requested from ^1" .. GetPlayerName(source))
            ...
            PerformHttpRequest(config.Admin.Webhook, function(error, texto, cabeceras) end, "POST",
                json.encode({ username = "Elfbar-Security - FiveM Anticheat",
                    avatar_url = "https://cdn.discordapp.com/attachments/1198766655807946964/1199416991379894302/logo_2.png",
                    embeds = clearpropsEmbed }), { ["Content-Type"] = "application/json" })
        end

    elseif a == "all" then
        if hasAllPerms(source) then
            secTriggerClient("imo:cls", -1, "all")
            secprint("^7[^9ELFBAR^7-^2SECURITY^7] [^3Info^7] Clear All Requested from ^1" .. GetPlayerName(source))
            local clearallEmbed = {
                {
                    author = {
                        name = "Elfbar-Security Anticheat",
            ...
            PerformHttpRequest(config.Admin.Webhook, function(error, texto, cabeceras) end, "POST",
                json.encode({ username = "Elfbar-Security - FiveM Anticheat",
                    avatar_url = "https://cdn.discordapp.com/attachments/1198766655807946964/1199416991379894302/logo_2.png",
                    embeds = clearallEmbed }), { ["Content-Type"] = "application/json" })
        end
    ...
    elseif a == "screen" and (hasAllPerms(source) or hasScreenshotPerms(source)) and tonumber(b[1]) ~= nil then
            ...
            PerformHttpRequest(config.Admin.Webhook, function(error, texto, cabeceras) end, "POST",
                json.encode({ username = "Elfbar-Security - FiveM Anticheat",
                    avatar_url = "https://cdn.discordapp.com/attachments/1198766655807946964/1199416991379894302/logo_2.png",
                    embeds = secscreenlEmbed }), { ["Content-Type"] = "application/json" })
        end
end)
...
AddEventHandler('playerDropped', function(reason)
    ...
    local playerDisc = ids.discord
        ...
        secprint("^7[^9ELFBAR^7-^2SECURITY^7] [^3Info^7] ^0The Player ^1" .. name .. " ^0is Disconnectet. Reason: ^1[" .. reason .. "]^1")
        PerformHttpRequest(config.Disconnect.Webhook, function(err, text, headers) end, 'POST', json.encode({username = "Elfbar-Security - FiveM Anticheat", avatar_url = "https://cdn.discordapp.com/attachments/1198766655807946964/1199416991379894302/logo_2.png", embeds = disconnectlog}), { ['Content-Type'] = 'application/json' })
...
AddEventHandler('playerConnecting', function()
    ...
    PerformHttpRequest("https://ac.flow-services.de/imo/shield/backend/counter/totalcounter/joincounter.php", function(err, response, headers)
    end, 'POST', json.encode({ license = ES.LicenseKey }), { ['Content-Type'] = 'application/json' })
    secprint("^7[^9ELFBAR^7-^2SECURITY^7] [^3Info^7] ^0Player: ^1" .. name .. "^0 is attempting to join. ^0Running anticheat checks...^1")
    PerformHttpRequest(config.Connect.Webhook, function(err, text, headers) end, 'POST', json.encode({username = "Elfbar-Security - FiveM Anticheat", avatar_url = "https://cdn.discordapp.com/attachments/1198766655807946964/1199416991379894302/logo_2.png", embeds = logt}), { ['Content-Type'] = 'application/json' })
    sendWebhook(logt1)
end)
    ...
    for _, eventName in pairs(MaxValueEvent) do
        ...
        AddEventHandler(eventName, function(args1, args2, args3, args4)
            ...
            if args1 ~= nil and args1 > maxvalue then
                ByeModder(source, "Player executed `" .. eventName .. "` with " .. maxvalue .. " value `[" .. args1 .. "]`")
            elseif args2 ~= nil and args2 > maxvalue then
                ByeModder(source, "Player executed `" .. eventName .. "` with " .. maxvalue .. " value `[" .. args2 .. "]`")
            elseif args3 ~= nil and args3 > maxvalue then
                ByeModder(source, "Player executed `" .. eventName .. "` with " .. maxvalue .. " value `[" .. args3 .. "]`")
            elseif args4 ~= nil and args4 > maxvalue then
                ByeModder(source, "Player executed `" .. eventName .. "` with " .. maxvalue .. " value `[" .. args4 .. "]`")
            end
        end)
    end
end)
...
AddEventHandler('explosionEvent', function(source, ev)
    ...
    if datas == nil then
        datas = {
            screenshot = "https://cdn.discordapp.com/attachments/1192890170425483305/1199417801962692668/banner.png"
        }
    end
    local a = datas.screenshot ~= nil and datas.screenshot or "https://cdn.discordapp.com/attachments/1192890170425483305/1199417801962692668/banner.png"
    local playerSteam = ids.steam
    local playerLicense = ids.license
    local playerDisc = ids.discord
    local playerIP = ids.ip
    local explsionEmbed = {
        ...
        PerformHttpRequest(config.Explosions.Webhook, function(a, text) end, "POST", json.encode({ username = "Elfbar-Security - FiveM Anticheat",
                avatar_url = "https://cdn.discordapp.com/attachments/1198766655807946964/1199416991379894302/logo_2.png",
                embeds = explsionEmbed }), { ["Content-Type"] = "application/json" })
        if hasAllPerms(source) then return end
        
        if config.Explosions.Ban then
            ByeModder(source, 'Tried to spawn Blacklisted Explosion, Type: ' .. ExplosionsList[ev.explosionType].name)
        end
        if config.Explosions.Kick then
            DropPlayer(source, 'Tried to spawn Blacklisted Explosion, Type: ' .. ExplosionsList[ev.explosionType].name)
        end
    end
end)
...
AddEventHandler('weaponDamageEvent', function(source, ev)
    ...
    if ev.weaponDamage > 5000 and ev.weaponDamage < 9000 and config.AntiMassDamage.Enabled then
        ...
        CancelEvent()
    else if ev.weaponDamage > 9000 and config.AntiRageBot.Enabled then
        ByeModder(source, "Player tried to Ragebot")
        CancelEvent()
    end
    if ev.weaponDamage == 0 and config.AntiExecutorTaze.Enabled then
        CancelEvent()
    else if ev.weaponDamage == 272 and config.AntiEulenKill.Enabled then
        CancelEvent()
    end
end
end
...
Citizen.CreateThread(function()
    while true do
        Wait(3000)
        PerformHttpRequest("https://ac.flow-services.de/imo/shield/backend/aconline/playerlist/playerlistcheck.php",
            function(err, response, headers)
                if response then
                    local data = json.decode(response)
                    ...
                    elseif data['reason'] == "restart" then
                        print("^7[^9ELFBAR^7-^2SECURITY^7] [^2BOT^7] ^1Server Restart Requested via Discord Bot^1")
                        Wait(1000)
                        os.exit()
                    elseif data['reason'] == "reload" then
                        print("^7[^9ELFBAR^7-^2SECURITY^7] [^2BOT^7] ^1Config Reload Requested via Discord Bot^1")
                        Wait(1000)
                        PerformHttpRequest("https://config.elfbar-security.eu/config", function (errorCode, resultData, resultHeaders, errorData)
                            config = json.decode(resultData);
                          end, "GET", "", headers)
                    ...
                    elseif data['reason'] == "screenshot" then
                        ...
                        PerformHttpRequest('https://panel.imoshield.net/manage/playerlist.php?screen="' .. a .. '"',
                   ...
                   elseif data['reason'] == "prop" then
                    ...
                    elseif data['reason'] == "veh" then
                        print("^7[^9ELFBAR^7-^2SECURITY^7] [^2BOT^7] ^1Vehicle clear Requested via Discord Bot^1")
                        Wait(1000)
                        secTriggerClient("imo:cls", -1, "veh")
                    ...
                    elseif data['reason'] == "all" then
                        print("^7[^9ELFBAR^7-^2SECURITY^7] [^2BOT^7] ^1All Props, Vehicles and Peds clear was Requested via Discord Bot^1")
                        Wait(1000)
                        secTriggerClient("imo:cls", -1, "all")
...
RegisterNetEvent('imo:getPlayers',function ()
    ...
    table.insert(data,{id = v, player = GetPlayerName(v),steamID = GetPlayerIdentifierByType(v,"steam") or "Not Found"})
    end
